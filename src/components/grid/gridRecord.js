        ...
        {this.state.edit_click ?
          <label className="checkbox-container"><span className="displayNone" aria-hidden="true">Checkbox</span>
            <input type="checkbox" tabIndex="0"/>
             <span className="checkmark"></span>
          </label> : <label className="checkbox-container"><span className="displayNone" aria-hidden="true">Checkbox</span>
        ...
        <div className="grid--row--child--container action--container">
          <div>
            ...
            {this.props.newRecord ? 
              <button className="btn-save" onClick={()=> this.saveData()} tabIndex="0" aria-label="save"><FaRegSave size={18} /></button> 
              : 
              (<span>
